      ...
      <nav id="nav-wrap">
        ...
        <a class="mobile-btn" href="#" title="Hide navigation">Hide navigation</a>
         ...
         <ul id="nav" class="nav">
            ...
            <li><a class="smoothscroll" href="#portfolio">Projets</a></li>
         </ul> <!-- end #nav -->
...
?>
      <div class="row banner">
         <div class="banner-text">
            <h1 class="responsive-headline">Je suis <?php echo isset($user) ? ucwords($user['firstname'].' '.$user['lastname']) : ""; ?>.</h1>
            <h3><?php echo stripslashes($_settings->info('welcome_message')) ?></h3>
            <hr />
            <ul class="social">
               <li><a target="_blank" href="mailto:<?php echo $contact['email'] ?>"><i class="fa fa-envelope"></i></a></li>
               <li><a target="_blank" href="<?php echo $contact['linkin'] ?>"><i class="fa fa-linkedin"></i></a></li>
               <li><a target="_blank" href="<?php echo $contact['twitter'] ?>"><i class="fa fa-github"></i></a></li>
            </ul>
         </div>
      </div>
   ...
   <section id="about">
      ...
      <div class="row">
         ...
         <img class="profile-pic" src="logo.png" alt="" style="width: 200px; height: auto;" />
   ...
   <section id="resume">
      ...
      <div class="row education">
         ...
         <div class="three columns header-col">
            <h1><span>Parcours scolaire</span></h1>
         </div>
...
<section id="skills">
   ...
   <div class="row skill">
      ...
      <div class="nine columns main-col">
         ...
         <!-- Skills List -->
         <ul class="skills">
            <li><em>Langague (Javascript, Typescript, Python, C, C++, C#, Node.js, React.Js, Angular.JS)</em></li>
            <li><em>Gestion de bases de données</em></li>
            <li><em>Maîtrise de github et gitlab</em></li>
            <li><em>Maîtrise de Linux et Windows server</em></li>
            <li><em>HTML, CSS, PHP</em></li>
            <li><em>Maîtrise de VMware</em></li>
            <li><em>Conception de systèmes</em></li>
            <li><em>Maîtriser du responsive design, l'UI/UX et l'interface mobile</em></li>
            <li><em>Microsoft, Excel, Power BI</em></li>
            <li><em>Azure, Cloud</em></li>
         </ul>

         <!-- Download CV Button -->
         <div class="download-button">
            <a href="Cv_Développement_mourad_ait_ameur.pdf" download="Cv_Développement_mourad_ait_ameur.pdf" class="button">Telecharger mon CV</a>
         </div>
   ...
   <section id="portfolio">
      ...
      <div class="row">
         ...
         <div class="twelve columns collapsed">
            ...
            <h1>Voir quelques-uns de mes travaux.</h1>
